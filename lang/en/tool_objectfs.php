...
$string['settings:presignedurl:roundingtime'] = 'Pre-Signed URL rounding time time';
$string['settings:presignedurl:roundingtime_help'] = 'This is a cache-friendly setting that allows the expiration time to be rounded and back dated so that a new URL is not generated each time the user visits the page.';
